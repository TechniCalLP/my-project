...
export default function AdminFirstLoginModal() {
  ...
  if (!session?.user?.isFirstLogin || session.user.adminRole !== "TEACHER") return null
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const res = await fetch("/api/password/admin-first-login", {
        method: "PATCH",
