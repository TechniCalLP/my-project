...
export default function TeacherStudentFilters() {
  ...
  const updateFilter = (key: string, value: string) => {
    ...
    params.delete("page")
    router.push(`/admin/my-students?${params.toString()}`)
  }
  ...
  const clearFilters = () => {
    setSearchTerm("")
    router.push("/admin/my-students")
  }

  const hasFilters = currentYear || searchTerm
